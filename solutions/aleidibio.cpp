...
#endif
  ll mins_from_h_to_a, mins_from_a_to_c, minute_of_day_film_start;
  read(mins_from_h_to_a, mins_from_a_to_c, minute_of_day_film_start);

  print(minute_of_day_film_start - mins_from_h_to_a - mins_from_a_to_c, NL);
