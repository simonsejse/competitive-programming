...
/* 2. FUNCTIONS */
#define strl_read(...) std::string __VA_ARGS__; read_lines(__VA_ARGS__)
...
int main(int argc, char* argv[]) {
  ...
  ll l1_delim = l1.find("|");
  ll l2_delim = l2.find("|");
  print(l1.substr(0, l1_delim), l2.substr(0, l2_delim));
  print(" ");
  print(l1.substr(l1_delim + 1, l1.length() - 1));
  print(l2.substr(l2_delim + 1, l2.length() - 1));
  return 0;
}
