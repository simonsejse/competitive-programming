...
mci score_dom = {{'A', 11}, {'K', 4},  {'Q', 3}, {'J', 20},
                 {'T', 10}, {'9', 14}, {'8', 0}, {'7', 0}};

mci score_not_dom = {{'A', 11}, {'K', 4}, {'Q', 3}, {'J', 2},
                     {'T', 10}, {'9', 0}, {'8', 0}, {'7', 0}};
...
int main(int argc, char* argv[]) {
  ...
  f(i, 0, a) {
    f(i, 0, 4) {
      str_read(card_suit);
      char card = card_suit[0];
      char suit = card_suit[1];
      IF(suit == dom_suit, p += score_dom[card], p += score_not_dom[card]);
    }
  }
  print(p);
  return 0;
